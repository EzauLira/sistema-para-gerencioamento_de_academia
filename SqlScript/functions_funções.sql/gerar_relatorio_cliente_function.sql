-- FUNCTION: public.gerar_relatorio_cliente()

-- DROP FUNCTION IF EXISTS public.gerar_relatorio_cliente();

CREATE OR REPLACE FUNCTION public.gerar_relatorio_cliente(
	)
...
ALTER FUNCTION public.gerar_relatorio_cliente()
    OWNER TO postgres;
