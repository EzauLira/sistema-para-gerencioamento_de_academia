-- FUNCTION: public.listar_treinos_ativos(integer)

-- DROP FUNCTION IF EXISTS public.listar_treinos_ativos(integer);
...
ALTER FUNCTION public.listar_treinos_ativos(integer)
    OWNER TO postgres;
