-- FUNCTION: public.listar_treinos_ativos(character varying)

-- DROP FUNCTION IF EXISTS public.listar_treinos_ativos(character varying);

CREATE OR REPLACE FUNCTION public.listar_treinos_ativos(
...
ALTER FUNCTION public.listar_treinos_ativos(character varying)
    OWNER TO postgres;
